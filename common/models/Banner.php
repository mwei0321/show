    ...
    class Banner extends ActiveRecord{
        ...
        **/
        static function getBannerList(){
            $bannerList = self::find()->select('id,type,obj_id')->orderBy('sort DESC')->asArray()->all();
            if($bannerList){
