...
<nav id="nav" class="nav-primary visible-lg nav-vertical">
    ...
    <ul class="nav" data-spy="affix" data-offset-top="50">
        ...
        <li class="<?php if(Yii::$app->controller->id == 'advertisement') echo 'active';?>"><a href="<?= Url::toRoute(['advertisement/manager']) ?>"><i class="icon-dashboard icon-xlarge"></i>广告位管理</a></li>
    </ul>
