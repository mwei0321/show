			...
			<section class="panel">
				...
				<div class="row">
					<form class="dynamic-data">
						...
						<div class="row col-lg-12"><label>链接</label><input  value="<?= $dynamicInfo['title'] ?? null ?>" type="text" id="dynamic-title" name="title" class="check checktitle" emsg="标题不能为空"></input></div>
